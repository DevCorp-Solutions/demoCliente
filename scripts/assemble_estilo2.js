...
// ==========================================
// 1. ASSEMBLE estilo2/index.html (ORIGINAL FULL WIDTH)
// ==========================================
...
// Header replacement for index.html: Full-width border-bottom bar (original template layout)
const oldHeaderRegex = /<div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px 28px;padding:18px clamp\(18px,4vw,56px\);border-bottom:2px solid #213A3C;font-family:'Alegreya Sans SC',sans-serif;font-weight:800;font-size:14px;letter-spacing:\.16em">[\s\S]*?<\/div>/;

const newHeaderHtml = `<div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px 24px;padding:14px clamp(18px,4vw,56px);border-bottom:2px solid #213A3C;background:#EBF4F3;font-family:'Alegreya Sans SC',sans-serif;font-weight:800;font-size:14px;letter-spacing:.12em">
...
console.log('Successfully wrote estilo2/index.html & Punto de Encuentro.dc.html (original full width)');


// ==========================================
// 2. ASSEMBLE estilo2/carta.html (ORIGINAL FULL WIDTH HEADER)
// ==========================================
...
const newCartaHeaderHtml = `<header data-screen-label="Carta · cabecera" style="background:#213A3C;color:#EBF4F3">
  ...
  <!-- CABECERA DEVCORP ADAPTADA AL ESTILO DEL LOCAL (FULL WIDTH COMO EL ORIGINAL) -->
...
console.log('Successfully wrote estilo2/carta.html & Carta.dc.html (original full width)');
