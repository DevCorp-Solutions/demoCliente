/**
 * DevCorp GastroSuite - Módulo Autónomo para ESTILO3
...
const STORAGE_KEY = 'devcorp_gastrosuite_state_estilo3_v1';
...
class GastroApp {
  ...
  renderMenuView(container, preset) {
    ...
    const layoutHtml = this.renderEstilo3Layout(preset, filteredMenu, activeCategory, activeAllergens, topData) + this.renderGoogleReviewsSection(preset);;
