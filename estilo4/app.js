/**
 * DevCorp GastroSuite - Módulo Autónomo para ESTILO4
...
const STORAGE_KEY = 'devcorp_gastrosuite_state_estilo4_v1';
...
class GastroApp {
  ...
  renderMenuView(container, preset) {
    ...
    const layoutHtml = this.renderEstilo4Layout(preset, filteredMenu, activeCategory, activeAllergens, topData) + this.renderGoogleReviewsSection(preset);;
